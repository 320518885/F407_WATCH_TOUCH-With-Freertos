...
void update_label_3_with_value(lv_ui *ui, int new_value);

void setup_scr_screen_1(lv_ui *ui)
{
    //Write codes screen_1
    ui->screen_1 = lv_obj_create(NULL);
    lv_obj_set_size(ui->screen_1, 270, 320);
    ...
    lv_obj_set_size(ui->screen_1_cont_1, 270, 320);
    ...
    lv_label_set_text(ui->screen_1_label_1, "为什么要点进来？");
    lv_label_set_long_mode(ui->screen_1_label_1, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_1_label_1, 28, 133);
    lv_obj_set_size(ui->screen_1_label_1, 235, 73);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_1, &lv_font_SourceHanSerifSC_Regular_26, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_btn_1_label, "回去");
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 77, 170);
    ...
    lv_obj_set_pos(ui->screen_1_sw_1, 17, 16);
    lv_obj_set_size(ui->screen_1_sw_1, 44, 20);
    ...
    lv_obj_set_style_bg_color(ui->screen_1_sw_1, lv_color_hex(0xa59c9c), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui->screen_1_label_2, "数据");
    lv_label_set_long_mode(ui->screen_1_label_2, LV_LABEL_LONG_WRAP);
    lv_obj_set_pos(ui->screen_1_label_2, 74, 13);
    ...
    lv_obj_set_style_text_font(ui->screen_1_label_2, &lv_font_SourceHanSerifSC_Regular_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_label_3, 77, 29);
...
void update_label_3_with_value(lv_ui *ui, int new_value)
{
    // 格式化数值并更新 screen_1_label_3 的文本
    lv_label_set_text_fmt(ui->screen_1_label_3, "%d", new_value);

    // 刷新 screen_1_label_3 以确保文本更新可见
    lv_obj_invalidate(ui->screen_1_label_3);
}
